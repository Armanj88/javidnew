...
class Javid_Elementor_Box_Icon_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'javid_box_icon';
    }

    public function get_title() {
        return esc_html__('Box Icon', 'javid');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .boxicon' => 'padding: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .boxicon' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
    ...
    protected function render() {
        ...
        ?>
        <div class="javid-elementor-widget boxicon clearfix" style="background-color: <?php echo $settings['bg_color']; ?>;">
            <div class="icon">
            ...
            <p class="boxicontitle" style="color: <?php echo $settings['textcolor']; ?>;">
