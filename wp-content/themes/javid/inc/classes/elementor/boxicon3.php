<?php
class Javid_Elementor_Box_Icon_3_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'javid_box_icon_3';
    }

    public function get_title() {
        return esc_html__('Box Icon 3', 'javid');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'input_type' => 'text',
                'placeholder' => __( 'Enter the link...', 'javid' ),
                'default' => __('#', 'javid'),
            ]
        );
        $this->add_control(
