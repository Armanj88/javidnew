...
class Javid_Elementor_Services_Box_2_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'javid_services_box_2';
    }

    public function get_title() {
        return esc_html__('Services Box 2', 'javid');
    }
    ...
    protected function render() {
        ...
        ?>
        <div class="javid-elementor-widget servicesbox" style="background-color: <?php echo $settings['bg_color']; ?>;">
            <div class="icon">
